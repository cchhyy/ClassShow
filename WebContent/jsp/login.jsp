 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <script type="text/javascript">
    	...
    	if(v){
    		var arr =v.split("<==>");
    		//将数组的0索引存放到用户名的输入框中,将数组的1索引存放到密码框中
    		$("#username").val(arr[0]);
    		$("#inputPassword3").val(arr[1]);
    	}
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <img src="${pageContext.request.contextPath}/img" id="imgYZM" onclick="changeImg()"/>
      <script type="text/javascript">
      		//获取验证码标签对象
      		function changeImg(){
      			$("#imgYZM").attr("src","${pageContext.request.contextPath}/img?abc="+new Date().getTime());
      		}
      </script>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="remember" value = "ok" checked="checked"> 记住我
        </label>
      </div>
    </div>
  </div>
